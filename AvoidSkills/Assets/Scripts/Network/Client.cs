...
public class Client : MonoBehaviour
{
    ...
    private void IntitializeClientData()
    {
        packetHandlers = new Dictionary<int, PacketHandler>()
        {
            ...
            {(int)ServerPackets.instantiateSkillCastEffect, ClientHandle.InstantiateSkillCastEffect},
            {(int)ServerPackets.instantiateSkillObject, ClientHandle.InstantiateSkillObject},
            {(int)ServerPackets.skillObjectPositionUpdate, ClientHandle.SkillObjectPositionUpdate},
            {(int)ServerPackets.skillObjectHit,ClientHandle.SkillObjectHit},
            {(int)ServerPackets.skillObjectExploded, ClientHandle.SkillObjectExploded},
            {(int)ServerPackets.destorySkillObject, ClientHandle.SkillObjectDestroyed},
            ...
            {(int)ServerPackets.startTestLab, ClientHandle.StartTestLab},
